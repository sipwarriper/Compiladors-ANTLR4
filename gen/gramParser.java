...
public class gramParser extends Parser {
	...
	public static class PruleContext extends ParserRuleContext {
		public List<TerminalNode> CHAR() { return getTokens(gramParser.CHAR); }
		public TerminalNode CHAR(int i) {
			return getToken(gramParser.CHAR, i);
		}
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof gramListener ) ((gramListener)listener).enterPrule(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof gramListener ) ((gramListener)listener).exitPrule(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof gramVisitor ) return ((gramVisitor<? extends T>)visitor).visitPrule(this);
